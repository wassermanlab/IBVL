...
process Mosdepth {
	...
	singularity exec -B /home -B /project -B /scratch -B /localscratch /mnt/common/SILENT/Act3/singularity/mosdepth-0.3.2.sif \
...
process multiqc_indiv {
	...
	script :
	"""
	mdule load singularity

	singularity exec -B /home -B /project -B /scratch -B /localscratch /mnt/common/SILENT/Act3/singularity/multiqc-1.9.sif \
	multiqc .
	"""
}
...
process deepvariant_call {
	...
	echo ${bam.simpleName}
	singularity exec -B /home -B /project -B /scratch -B /localscratch /mnt/common/SILENT/Act3/singularity/deepvariant-1.2.0.sif \
...
process GLnexus_cli {
	...
	singularity exec -B /home -B /project -B /scratch -B /localscratch /mnt/common/SILENT/Act3/singularity/glnexus-1.4.1.sif \
	glnexus_cli \
	--config DeepVariant \
